...
| [docs/backup-restore.md](docs/backup-restore.md) | Taking a backup of every account, the file format, and how a restore merges — progress by union, purchases never revoked. |
